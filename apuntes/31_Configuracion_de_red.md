...
La tabla ARP de un equipo se puede manejar con el comando ip y usando *neighbour* como primer parámetro. Algunos ejemplos de manejo de la tabla ARP son los siguientes:
